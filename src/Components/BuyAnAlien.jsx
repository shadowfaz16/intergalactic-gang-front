    ...
    <>
      ...
      <section id="distribution">
        <div className="container border-t border-redish px-6 py-10 md:p-10">
          {/* flex container */}
          <div className="container flex flex-col rounded-md items-center p-6 space-y-3 bg-blackCards dark:bg-bgWhite md:flex-row md:space-y-0 md:py-10 md:mx-auto md:justify-around">
            {/* left item */}
            ...
            <div className="flex">
              <p className="max-w-xl text-center md:text-lg dark:text-bgBlack text-eelg md:text-justify">
                ...
                <span className="text-redish hover:underline underline-offset-4 hover:cursor-pointer hover:ease-in-out hover:text-shadow-lg">
                  See Record and Proof
                </span>
                ) Minting an alien costs 0.07 ETH.
              </p>
            </div>
            {/* right item */}
