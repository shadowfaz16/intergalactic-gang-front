      ...
      <section id="dream-team">
        ...
        <div className="container flex flex-col items-center mx-auto p-10 space-y-7 md:flex-row md:items-end md:space-x-10 border-t border-redish">
          ...
          <div className="flex flex-col space-y-5 md:w-1/2">
            ...
            <div className="flex flex-col items-center bg-bgBlack dark:bg-white p-5 space-y-3 rounded-md md:flex-row md:items-start md:space-x-8 md:space-y-0 md:h-44">
                <div>
          ...
          {/* right item */}
           <div className="flex flex-col items-center bg-bgBlack dark:bg-white p-5 space-y-3 rounded-md md:flex-row md:items-start md:space-x-8 md:space-y-0 md:h-44 md:w-1/2">
                <div>
